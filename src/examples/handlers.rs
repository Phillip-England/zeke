...
pub const NAVBAR: &str = r#"
    <nav>
        <a href='/'>Home</a> | 
        <a href='/about'>About</a> | 
        <a href='/test/query_params?name=zeke&age=your mom'>Query Params</a> | 
        <a href='/test/set_cookie'>Set Cookie</a> |
        <a href='/test/clear_cookie'>Clear Cookie</a> |
    </nav>
"#;
...
pub fn handle_clear_cookie() -> Handler {
	return Handler::new(|request| {
		let response = Response::new()
			.status(200)
			.body(&base_template("Set Cookie"))
